...
NUM=1
SWEEP_ID="6h4052mx"
CUDA_VISIBLE_DEVICES=4 HF_DATASETS_OFFLINE=0 TRANSFORMERS_OFFLINE=0 HF_EVALUATE_OFFLINE=0 wandb agent --count $NUM simpleparadox/train_bert_pos_tagger/$SWEEP_ID
